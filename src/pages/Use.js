...
const Use = () => {
    return (
        <div>
            ...
            <p>
                Par exemple, ce site contient 3 pages Home.js, Install.js et
                Use.js.
            </p>
            <ul>
                <li>Importer Routes et Route</li>
                <li>
                    Créer des Route dans Routes en respectant path et element
                </li>
            </ul>
            ...
            <h3>Etape 3 :</h3>
            <p>
                Créer votre Navbar.js (vous pouvez mettre n'importe quel nom).
            </p>
            <ul>
                <li>Importer Link</li>
                <li>
                    Créer une balise nav avec des Link en spécifiant le to=" "
                </li>
            </ul>
